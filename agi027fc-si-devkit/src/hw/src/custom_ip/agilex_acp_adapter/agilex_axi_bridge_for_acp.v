...
module agilex_axi_bridge_for_acp #(
		parameter GPIO_EN = 0,
		parameter CSR_EN = 1,
		parameter ARDOMAIN_OVERRIDE = 2'h0,
		parameter ARBAR_OVERRIDE = 2'h0,
		parameter ARSNOOP_OVERRIDE = 4'h0,
		parameter ARCACHE_OVERRIDE = 4'h2,
		parameter AWDOMAIN_OVERRIDE = 2'h0,
		parameter AWBAR_OVERRIDE = 2'h0,
		parameter AWSNOOP_OVERRIDE = 3'h0,
		parameter AWCACHE_OVERRIDE = 4'h2,
		parameter AxUSER_OVERRIDE = 8'he0,    // route to ccu
		parameter AxPROT_OVERRIDE = 3'h1,
...
//      output wire [3:0]   axm_m0_arregion,
		...
		input  wire [4:0]   axs_s0_arid,    //      .arid
		...
		input  wire [4:0]   axs_s0_awid,    //      .awid
		...
		output wire [4:0]   axs_s0_bid,     //      .bid
		...
		output wire [4:0]   axs_s0_rid,     //      .rid
