...
# parameters
# 
add_parameter FTILE_HIP_PAUSE_EN INTEGER 0 ""
set_parameter_property FTILE_HIP_PAUSE_EN DEFAULT_VALUE 0
set_parameter_property FTILE_HIP_PAUSE_EN DISPLAY_NAME "FtileHIP_PauseEnable"
set_parameter_property FTILE_HIP_PAUSE_EN ALLOWED_RANGES {"1" "0"}
set_parameter_property FTILE_HIP_PAUSE_EN DESCRIPTION "Ftile HIP Pause Control Enable"
set_parameter_property FTILE_HIP_PAUSE_EN HDL_PARAMETER false
...
# 
# connection point pause_ctrl_ftile_src_data
# 
add_interface pause_ctrl_ftile_src_data conduit end
set_interface_property pause_ctrl_ftile_src_data associatedClock ""
set_interface_property pause_ctrl_ftile_src_data associatedReset ""
set_interface_property pause_ctrl_ftile_src_data ENABLED true
set_interface_property pause_ctrl_ftile_src_data EXPORT_OF ""
set_interface_property pause_ctrl_ftile_src_data PORT_NAME_MAP ""
set_interface_property pause_ctrl_ftile_src_data CMSIS_SVD_VARIABLES ""
set_interface_property pause_ctrl_ftile_src_data SVD_ADDRESS_GROUP ""
set_interface_property pause_ctrl_ftile_src_data IPXACT_REGISTER_MAP_VARIABLES ""

add_interface_port pause_ctrl_ftile_src_data pause_ctrl_ftile_src_data i_sl_tx_pause Output 1
add_interface_port pause_ctrl_ftile_src_data o_sl_rx_pause o_sl_rx_pause Input 1

proc elaborate {} {
    if { [get_parameter_value FTILE_HIP_PAUSE_EN] == 1 } {
		set_interface_property   pause_control_source   		ENABLED 0
		set_interface_property   pause_ctrl_ftile_src_data   	ENABLED 1
	} else {
		set_interface_property   pause_control_source   		ENABLED 1
		set_interface_property   pause_ctrl_ftile_src_data   	ENABLED 0
	}
}