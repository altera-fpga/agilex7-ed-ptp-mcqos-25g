...
//
// ftile_hip_adapter
// This component is an conduit adapther for FTILE HIP IP
//****************************************************************************

module ftile_hip_adapter #(
...
//Terminted with 0 in ED //   //AVMM Slave for eth_reconfig
//Terminted with 0 in ED //    input  [ETH_RECONFIG_ADDRESS_WIDTH-1:0]   eth_reconfig_address,       // avalon_slave
//Terminted with 0 in ED //    input                                     eth_reconfig_read,          // avalon_slave
//Terminted with 0 in ED //    input                                     eth_reconfig_write,         // avalon_slave
//Terminted with 0 in ED //    input  [31:0]                             eth_reconfig_writedata,     // avalon_slave
//Terminted with 0 in ED //    output [31:0]                             eth_reconfig_readdata,      // avalon_slave
//Terminted with 0 in ED //    output                                    eth_reconfig_readdatavalid, // avalon_slave
//Terminted with 0 in ED //    output                                    eth_reconfig_waitrequest,   // avalon_slave
...
// ptp reconfig
//Terminted with 0 in ED //    //AVMM Slave for ptp_reconfig
//Terminted with 0 in ED //    input  [ETH_RECONFIG_ADDRESS_WIDTH-1:0]   ptp_reconfig_address,          // avalon_slave
//Terminted with 0 in ED //    input                                     ptp_reconfig_read,             // avalon_slave
//Terminted with 0 in ED //    input                                     ptp_reconfig_write,            // avalon_slave
//Terminted with 0 in ED //    input  [7:0]                              ptp_reconfig_writedata,        // avalon_slave
//Terminted with 0 in ED //    output [7:0]                              ptp_reconfig_readdata,         // avalon_slave
//Terminted with 0 in ED //    output                                    ptp_reconfig_waitrequest,      // avalon_slave
...
//BasicMode// // ptp_tod_ports_adapter_in
//BasicMode//     input   [95:0]                            ptp_tod_ports_adapter_in,
//BasicMode// // ptp_tod_ports
//BasicMode//     output  [95:0]                            i_ptp_tod,
...
//eth_reconfig
//Terminted with 0 in ED //  assign i_eth_reconfig_addr          = eth_reconfig_address;
//Terminted with 0 in ED //  assign i_eth_reconfig_read          = eth_reconfig_read;
//Terminted with 0 in ED //  assign i_eth_reconfig_write         = eth_reconfig_write;
//Terminted with 0 in ED //  assign i_eth_reconfig_writedata     = eth_reconfig_writedata;
//Terminted with 0 in ED //  assign eth_reconfig_readdata        = o_eth_reconfig_readdata;     
//Terminted with 0 in ED //  assign eth_reconfig_readdatavalid   = o_eth_reconfig_readdata_valid;
//Terminted with 0 in ED //  assign eth_reconfig_waitrequest     = o_eth_reconfig_waitrequest;
...
//ptp_reconfig
// termintate with 0 in ED //  assign i_ptp_reconfig_address         = ptp_reconfig_address;
// termintate with 0 in ED //  assign i_ptp_reconfig_read            = ptp_reconfig_read;
// termintate with 0 in ED //  assign i_ptp_reconfig_write           = ptp_reconfig_write;
// termintate with 0 in ED //  assign i_ptp_reconfig_writedata       = ptp_reconfig_writedata;
// termintate with 0 in ED //  assign ptp_reconfig_readdata          = o_ptp_reconfig_readdata;     
// termintate with 0 in ED //  assign ptp_reconfig_waitrequest       = o_ptp_reconfig_waitrequest;
...
assign i_sl_tx_skip_crc                 = 1'b0; // follow termination in the Example design                          
...
//assign sl_rxstatus_data               = o_sl_rxstatus_data;                   
//assign sl_rxstatus_valid              = o_sl_rxstatus_valid;                  

// SL CLK & RST
assign i_sl_clk_tx                      = sl_clk_tx;
//assign i_sl_tx_rst_n                    = sl_rst_tx;
...
//assign i_csr_rst_n                    = i_reconfig_reset;
//assign i_sl_csr_rst_n                 = i_reconfig_reset;
...
//Basic Mode//  assign i_ptp_tod                        = ptp_tod_ports_adapter_in;
